...
class BuildGradle {
  ...
  Future<void> build() async {
    ...
    // Remove outputs from architectures selected by an earlier build. AGP
    // otherwise treats those stale .so files as current JNI inputs even after
    // the project changes to a narrower target-platform set.
